...
namespace airs
{
	static constexpr const char* GetVShader()
	{
		return
			"#version 330 core\n"
			"uniform int Time = 0;"
	...
	static constexpr const char* GetGShader()
	{
		return
			"#version 330 core\n"
			"layout(points) in;"
	...
	static constexpr const char* GetFShader()
	{
		return
			"#version 330 core\n"
			"uniform usamplerBuffer TextureBuffer;"
	...
	Spriteset::Spriteset(size_t capacity) :
		SpritesShader(GetVShader(), GetGShader(), GetFShader()),
